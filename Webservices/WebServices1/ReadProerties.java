...
public class ReadProerties {
	...
	public static String[] propsObjectsSplit(String objectname, int totalSeparate) {
		return ReadProerties.getObjectRepository("./files").getProperty(objectname).split("=", totalSeparate);
	}

	public static String propsObjectsSplit(String objectname) {
		try {
			return ReadProerties.getObjectRepository("./files").getProperty(objectname);
	...
	public static void main(String[] args) {
			System.out.println("username:"+propsObjectsSplit("username"));
	}
